...
d3.csv('me/data/me.csv', function (data) {
    ...
    var monthlyDimensionGroup = monthlyDimension.group();

    var typeDimension = ndx.dimension(function (d) {
        return d.type;
    });

    var typeDimensionGroup = typeDimension.group();

    var ratingDimension = ndx.dimension(function (d) {
        return d.rating;
    });

    var ratingDimensionGroup = ratingDimension.group();
